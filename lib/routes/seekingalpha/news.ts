...
async function handler() {
    ...
    const response = await ofetch(`${baseUrl}/api/v3/news`, {
        headers: {
        ...
        query: {
            'fields[news]': 'title,date,comment_count,content,primaryTickers,secondaryTickers,tag,gettyImageUrl,publishOn',
